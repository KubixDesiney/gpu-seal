...
- [x] ~~**Generate real lock file hashes.**~~ **Done** — 17 packages, transitive closure, resolved against `manylinux2014_x86_64` / Python 3.11 so the hashes match the wheels the *image* installs. `lab/regenerate-lock.py` regenerates them.
